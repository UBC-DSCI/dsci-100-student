...
test_0.2 <- function(){
test_that('Did not create an object named answer0.2', {
    expect_true(exists('answer0.2'))
    })
test_that('Solution is incorrect', {
    expect_equal(digest(answer0.2), '01a75cb73d67b0f895ff0e61449c7bf8')
}) 
    print("Success!")
...
test_0.3 <- function(){
test_that('Did not create an object named answer0.3', {
    expect_true(exists('answer0.3'))
    })
test_that('Solution is incorrect', {
    expect_equal(digest(answer0.3), '3a5505c06543876fe45598b5e5e5195d')
}) 
    print("Success!")
...
test_that('Solution is incorrect', {
    expect_equal(digest(answer2.7), 'e39846a2072bf1764fb151015610f934')
}) 
    print("Success!")
...
test_2.8 <- function(){
test_that('Did not create an object named answer2.8', {
    expect_true(exists('answer2.8'))
    })
test_that('Solution is incorrect', {
    expect_equal(digest(answer2.8), '6717f2823d3202449301145073ab8719')
}) 
    print("Success!")
