...
test_2.1 <- function(){
    test_that('Solution is incorrect', {
        ...
        expect_equal(digest(int_round(sum(as.integer(counts$count)), 2)), '9ecacdf4df8df05e2501eb3f18bd13ab')
    })
    print("Success!")
}
...
test_2.2 <- function(){
    ...
    test_that('Solution is incorrect', {
        expect_equal(digest(answer2.2), '05ca18b596514af73f6880309a21b5dd')
    })
    print("Success!")
}
...
test_3.0 <- function(){
    ...
    test_that('testing_set does not contain the correct data', {
        ...
        expect_equal(digest(int_round(sum(as.integer(testing_set$X100)),2)), '5b56a2faf81d499e06c0993091f01ed6')
    })
    ...
    test_that('training_set does not contain the correct data',{
        ...
        expect_equal(digest(int_round(sum(as.integer(training_set$X100)),2)), '52d1f49ad951b69d367869fdf5662e24')
    })
    print("Success!")
}
...
test_3.2 <- function(){
    ...
    test_that('cross_val_plot does not contain the correct data.', {
        expect_equal(digest(int_round(sum(cross_val_plot$data$mean), 2)), '6ca7cc749fd4a42cbb696b277e63b677')
        expect_equal(digest(int_round(sum(cross_val_plot$data$n), 2)), '45406a48666dcf764d5fead427284f8e')
    })
