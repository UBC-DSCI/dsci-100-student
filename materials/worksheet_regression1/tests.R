...
test_8.0 <- function(){
    ...
    test_that('marathon_results does not contain the correct data', {
        ...
        expect_equal(digest(int_round(sum(marathon_results$mean), 0)), '4db0d56610aefad993e7007d4340c4c5')
        expect_equal(digest(int_round(sum(marathon_results$std_err), 0)), '8eaca7c9b35d05ab15c9125bc92372fa')
    })
print("Success!")
}
