...
test_3.1 <- function() {
    ...
    test_that('marathon_training does not contain 0.75 of the marathon data', {
        ...
        expect_equal(digest(int_round(sum(marathon_training$max), 0)), '94e91e5e6573ddfedb81802729c39543')
    ...
    test_that('marathon testing does not contain 0.25 of the marathon data', {
        ...
        expect_equal(digest(int_round(sum(marathon_testing$max), 0)), '8049ebf85d7d9bc2b8baac5c119d4c21')
        expect_equal(digest(int_round(sum(marathon_testing$time_hrs), 0)), 'a18d76f4b0bcad9715a7c592f28ac622')
    })
    print("Success!")
}
...
test_3.3.1 <- function() {
    ...
    test_that('lm_recipe does not contain the correct variables', {
        expect_equal(digest(int_round(sum(lm_recipe$template$max), 0)), '94e91e5e6573ddfedb81802729c39543')
    ...
    test_that('lm_fit does not contain the correct data', {
        expect_equal(digest(int_round(sum(lm_fit$pre$actions$recipe$recipe$template$max), 0)), '94e91e5e6573ddfedb81802729c39543')
...
test_3.5 <- function() {
    ...
    test_that('lm_test_results does not contain the correct data', {
        ...
        expect_equal(digest(int_round(sum(lm_test_results$.estimate), 1)), 'e03a89536262b6a0e2beabd90a841c43')
    })
