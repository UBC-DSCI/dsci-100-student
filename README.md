...
| 7    | Midterm (during week 7 tutorial)                 | Covers week 1-3 concepts                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    
| 8    | Classification, continued                        | This chapter continues the introduction to predictive modeling through classification. While the previous chapter covered training and data preprocessing, this chapter focuses on how to evaluate the performance of a classifier, as well as how to improve the classifier (where possible) to maximize its accuracy. |                                                                                                                                                            | 8    | Project proposal due                             |                                                                                                                                                                                                                                                                        
...
| 15   | Final                                            | Cumulative. Covers all the material. To be Scheduled by To be scheduled by Classroom Services                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
